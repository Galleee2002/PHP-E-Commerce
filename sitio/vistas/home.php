<section class="hero" style="background-image: url('imgs/fotobanner.webp');">
    <div class="hero__overlay"></div>
    <div class="hero__content">
        <h1 class="hero__title">Los mejores juegos de mesa, en un solo lugar</h1>
        <p class="hero__description">Descubrí un mundo de diversión sin pantallas. Explorá nuestra selección de juegos de mesa para todas las edades y estilos: estrategia, cooperación, clásicos y novedades. Ya sea para una noche con amigos o en familia, encontrá el juego perfecto para compartir momentos únicos. ¿Listo para jugar?</p>
        <a class="btn btn--light" href="index.php?seccion=listado">Explorá nuestros juegos</a>
    </div>
</section>

<section class="home-categories home-section" aria-labelledby="categorias-destacadas">
    <h2 class="home-block-title" id="categorias-destacadas">Categorías destacadas</h2>
    <article class="home-category-card" style="background-image: url('imgs/home-rompecabezas.webp');">
    ...
    <article class="home-category-card" style="background-image: url('imgs/home-misterio.webp');">
    ...
    <article class="home-category-card" style="background-image: url('imgs/home-estrategia.webp');">
...
<section class="home-benefits home-section" aria-labelledby="beneficios">
    ...
    <div class="home-benefits__grid">
        ...
        <article class="home-benefit-card">
            <div class="home-benefit-card__content">
                <p class="home-benefit-card__eyebrow">Logística eficiente</p>
                <div class="home-benefit-card__heading">
